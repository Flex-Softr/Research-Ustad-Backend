...
const authorSchema = z.object({
  ...
  name: z.string().min(2, "Author name must be at least 2 characters").optional(),
  ...
  return authors.map(author => {
    ...
    if (typeof author === 'object' && author !== null) {
      ...
      if (authorObj.user) {
        ...
        } else if (typeof authorObj.user === 'object' && authorObj.user !== null) {
...
export const researchPaperSchema = z.object({
    body:z.object({
        ...
        status: z.enum(["published", "ongoing", "under_review", "in_preparation", "revision"]).optional(),
